...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.log('[OAuth Callback] Supabase URL:', process.env.NEXT_PUBLIC_SUPABASE_URL)
    console.log('[OAuth Callback] Supabase Key exists:', !!process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY)
    ...
    if (profile) {
      ...
      redirectTo = next
      console.log('[OAuth Callback] Profile not found, redirecting to dashboard')
    }
